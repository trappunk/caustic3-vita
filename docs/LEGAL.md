...
Caustic is copyrighted software created by Rej Poirier / Single Cell Software.
This repository is an unofficial interoperability wrapper and is not endorsed
by or affiliated with the Caustic developer, Single Cell Software, Sony, or
PlayStation.

The final Android maintenance build being free to download does not make
Caustic open source, public domain, or freely redistributable in every form.
...
holder will be handled promptly.
