...
| Audio output | Working | Direct 44.1 kHz Vita BGM output with accurate DSP math bridging. |
| Synth and BeatBox playback | Working | Preset-dependent redlining and harsh noise were fixed in 01.03. |
